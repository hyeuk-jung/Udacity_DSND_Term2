...
/* TODO: Use the year, arable_land_brazil, and country_name_brazil to create a trace for a line chart */
    x: year, // x-axis
    y: arable_land_brazil, // y-axis
    name: country_name_brazil, // legend
    mode: 'lines', // graph type --> markers, lines+markers
    type: 'scatter'
};
...
/* TODO: Create another trace for the Germany data using a line chart */
    x: year, // x-axis
    y: arable_land_germany, // y-axis
    name: country_name_germany, // legend
...
/* TODO: Create another trace for the China data using a line chart */
    x: year, // x-axis
    y: arable_land_china, // y-axis
    name: country_name_china, // legend
    mode: 'lines', // graph type
    type: 'scatter'
};
